...
User _userDeserialize(
  ...
  final object = User(
    ...
    hasCompletedOnboarding: reader.readBoolOrNull(offsets[3]) ?? false,
    passwordHash: reader.readString(offsets[5]),
    username: reader.readString(offsets[6]),
  );
  object.createdAt = reader.readDateTime(offsets[0]);
  object.id = id;
  object.lastLoginAt = reader.readDateTime(offsets[4]);
  return object;
}
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> lastLoginAtEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'lastLoginAt', value: value),
      );
    });
  }
